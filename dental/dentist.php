    ...
    <div id="container">
        <div id="content">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($errors)) {
                    $q = "INSERT INTO dentist (name, sex, age, phone, address, email, dtype, registration_date)
            ...
            <form action="dentist.php" method="post" class="form">
                ...
                <p><label class="label" for="dtype">Dentist Type:</label>
                <select name="dtype">
                    <option <?php if (isset($_POST['dtype']) && $_POST['dtype'] == 'Permanent') echo 'selected'; ?>>Permanent</option>
                    <option <?php if (isset($_POST['dtype']) && $_POST['dtype'] == 'Trainee') echo 'selected'; ?>>Trainee</option>
                    <option <?php if (isset($_POST['dtype']) && $_POST['dtype'] == 'Visiting') echo 'selected'; ?>>Visiting</option>
                </select></p>
